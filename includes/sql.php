...
/*--------------------------------------------------------------*/
 ...
 function find_higest_saleing_policy(){
  global $db;
  $sql  = "SELECT product, COUNT(product) AS product_count";
  $sql .= " FROM policy_sale";
 ...
 function find_all_Psale(){
  global $db;
  $sql  = "SELECT * from policy_sale";
  return find_by_sql($sql);
}
 /*--------------------------------------------------------------*/
